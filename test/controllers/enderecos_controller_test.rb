...
class EnderecosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post enderecos_url, params: { endereco: { Pessoa_id: @endereco.Pessoa_id, bairro: @endereco.bairro, cep: @endereco.cep, cidade: @endereco.cidade, complemento: @endereco.complemento, num_comodos: @endereco.num_comodos, numero: @endereco.numero, pais: @endereco.pais, rua: @endereco.rua, tipo_moradia: @endereco.tipo_moradia, uf: @endereco.uf } }
    end
  ...
  test "should update endereco" do
    patch endereco_url(@endereco), params: { endereco: { Pessoa_id: @endereco.Pessoa_id, bairro: @endereco.bairro, cep: @endereco.cep, cidade: @endereco.cidade, complemento: @endereco.complemento, num_comodos: @endereco.num_comodos, numero: @endereco.numero, pais: @endereco.pais, rua: @endereco.rua, tipo_moradia: @endereco.tipo_moradia, uf: @endereco.uf } }
