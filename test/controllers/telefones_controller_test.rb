...
class TelefonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create telefone" do
    assert_difference('Telefone.count') do
      post telefones_url, params: { telefone: { Pessoa_id: @telefone.Pessoa_id, num_tel: @telefone.num_tel } }
    end
  ...
  test "should update telefone" do
    patch telefone_url(@telefone), params: { telefone: { Pessoa_id: @telefone.Pessoa_id, num_tel: @telefone.num_tel } }
