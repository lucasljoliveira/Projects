...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post funcionarios_url, params: { funcionario: { Pessoa_id: @funcionario.Pessoa_id, num_crefito: @funcionario.num_crefito } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { Pessoa_id: @funcionario.Pessoa_id, num_crefito: @funcionario.num_crefito } }
